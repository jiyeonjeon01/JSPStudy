...
function onLoad() {
   ...
   // 회원가입 폼 시작 
    ...
    const inputPW1 = document.querySelector(".idDetailInput2");
    const inputPW2 = document.querySelector(".idReDetailInput2");
    const inputName = document.querySelector(".nameDetailInput2");
    const inputEmail = document.querySelector(".emilDetailInput2");
    const inputMobile = document.querySelector(".phoneDetailInput2");
