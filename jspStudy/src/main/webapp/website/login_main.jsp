...
<body>
	...
	<form method="post" action="<%= request.getContextPath()%>/login/loginCheck.jsp">
		...
		<table border="1" width="300" id="my_table">
			...
			<tr>
				<td align="center" colspan="2"><input type="button"
					onclick="location.href = 'register.jsp'" value="회원가입"> <input
	...
	<table border="1" width="500" id="my_table">
		...
		<tr>
			<td align="center"><input type="button"
				onclick="location.href = 'memberList.jsp'" value="회원들 정보">
	...
	<table border="1" width="500" id="my_table">
		...
		<tr>
			<td align="center">
				<input type="button" onclick="location.href = 'memberChange.jsp'" value="회원정보변경">
				<input type="button" onclick="location.href = 'logout.jsp'" value="로그아웃"> 
				<input type="button" onclick="location.href = 'deleteQuestion.jsp'" value="탈퇴하기">
			</td>
		</tr>
	</table>
	<%
